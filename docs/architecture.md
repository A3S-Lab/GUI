...
client liveness and graceful protocol shutdown. The remaining critical work is:
...
3. zero-configuration TSX startup, host-initiated liveness, crash recovery, and
   replay over the landed Node/Rust application pump;
