...
pub(in crate::style) fn tailwind_semantic_color(value: &str) -> Option<&'static str> {
    match value {
        // shadcn-compatible semantic aliases, backed by DESIGN.md's Expo/Vercel palette.
        "background" | "canvas" | "card" | "popover" | "elevated" | "canvas-elevated" => {
            Some("#ffffff")
        }
        "foreground" | "ink" | "card-foreground" | "popover-foreground" | "body-strong" => {
            Some("#171717")
        }
        "primary" => Some("#000000"),
        "primary-active" => Some("#1a1a1a"),
        "primary-foreground" | "on-primary" => Some("#ffffff"),
        "surface-pressed" | "surface-strong" | "secondary" | "muted" | "accent" => Some("#f0f0f3"),
        "black-elevated" | "surface-dark-elevated" => Some("#1a1a1a"),
        "canvas-soft" | "surface-soft" => Some("#fafafa"),
        "canvas-softer" | "hairline" | "border" | "hairline-soft" => Some("#f0f0f3"),
        "secondary-foreground" | "accent-foreground" => Some("#171717"),
        "surface-dark" => Some("#171717"),
        "muted-foreground" | "body" => Some("#60646c"),
        "hairline-mid" | "charcoal" => Some("#dcdee0"),
        "mute" | "faint" => Some("#999999"),
        "muted-soft" => Some("#cccccc"),
        "on-dark" => Some("#ffffff"),
        "on-dark-mute" | "on-dark-soft" => Some("#b0b4ba"),
        "destructive" | "error" | "semantic-error" => Some("#eb8e90"),
        "destructive-foreground" | "error-foreground" | "on-error" => Some("#ffffff"),
        "input" | "hairline-strong" => Some("#dcdee0"),
        "ring" => Some("#171717"),
        "success" | "semantic-success" => Some("#16a34a"),
        "link" | "link-blue" | "text-link" => Some("#0d74ce"),
        "link-deep" | "text-link-secondary" => Some("#476cff"),
        "link-soft" | "accent-link-bright" => Some("#47c2ff"),
        "warning" | "accent-warning" => Some("#ab6400"),
        "preview" | "accent-preview" => Some("#8145b5"),
        "violet" | "magenta" => Some("#8145b5"),
        "cyan" => Some("#47c2ff"),
        "pink" => Some("#eb8e90"),
        "gradient-develop-start" | "chart-1" => Some("#000000"),
        "gradient-develop-end" | "chart-2" => Some("#1a1a1a"),
        "gradient-preview-start" | "chart-3" => Some("#8145b5"),
        "gradient-preview-end" | "chart-4" => Some("#0d74ce"),
        "gradient-ship-start" => Some("#16a34a"),
        "gradient-ship-end" | "chart-5" => Some("#ab6400"),
        "gradient-sky-light" => Some("#cfe7ff"),
        "gradient-sky-mid" => Some("#a8c8e8"),
        "terminal-red" => Some("#eb8e90"),
        "terminal-yellow" => Some("#ab6400"),
        "terminal-green" => Some("#16a34a"),
        "sidebar" => Some("#ffffff"),
        "sidebar-foreground" => Some("#171717"),
        "sidebar-primary" => Some("#000000"),
        "sidebar-primary-foreground" => Some("#ffffff"),
        "sidebar-accent" => Some("#f0f0f3"),
        "sidebar-accent-foreground" => Some("#171717"),
        "sidebar-border" => Some("#f0f0f3"),
        "sidebar-ring" => Some("#171717"),
        _ => None,
    }
}
