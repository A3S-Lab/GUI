...
pub(in crate::style) fn tailwind_semantic_color(value: &str) -> Option<&'static str> {
    match value {
        // Canonical semantic colors from the repository root DESIGN.md.
        "canvas" => Some("#ffffff"),
        "canvas-soft" => Some("#fafafa"),
        "surface-card" => Some("#ffffff"),
        "surface-strong" => Some("#f0f0f3"),
        "surface-dark" => Some("#171717"),
        "surface-dark-elevated" => Some("#1a1a1a"),
        "gradient-sky-light" => Some("#cfe7ff"),
        "gradient-sky-mid" => Some("#a8c8e8"),
        "hairline" => Some("#f0f0f3"),
        "hairline-soft" => Some("#f5f5f7"),
        "hairline-strong" => Some("#dcdee0"),
        "ink" => Some("#171717"),
        "body" => Some("#60646c"),
        "body-strong" => Some("#171717"),
        "muted" => Some("#999999"),
        "muted-soft" => Some("#cccccc"),
        "primary" => Some("#000000"),
        "primary-active" => Some("#1a1a1a"),
        "text-link" => Some("#0d74ce"),
        "text-link-secondary" => Some("#476cff"),
        "accent-link-bright" => Some("#47c2ff"),
        "accent-warning" => Some("#ab6400"),
        "accent-preview" => Some("#8145b5"),
        "semantic-success" => Some("#16a34a"),
        "semantic-error" => Some("#eb8e90"),
        "on-primary" => Some("#ffffff"),
        "on-dark" => Some("#ffffff"),
        "on-dark-soft" => Some("#b0b4ba"),
        _ => None,
    }
}
