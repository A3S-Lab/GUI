...
use tailwind_utilities::{
    ...
    tailwind_color, tailwind_edge_utility, tailwind_length, tailwind_max_width_value,
    tailwind_opacity, tailwind_scrollbar_color_pipeline, tailwind_utility_declarations,
};
