        ...
        >
            <UiToolbar key="root-stack" orientation="vertical" className="w-full gap-5 rounded-none border-none bg-transparent p-0">
                <UiToolbar key="overlay-grid" orientation="horizontal" className="grid w-full grid-cols-2 gap-4 rounded-none border-none bg-transparent p-0">
                    <UiGroup key="dialog-card" label="Dialog primitives" className="gap-3 rounded-lg border border-hairline-strong bg-canvas p-4">
                        <UiDialogTrigger key="dialog-trigger" isOpen={overlayOpen} onPress={openOverlay} actionValue="dialog">Open dialog</UiDialogTrigger>
                        <UiDialog key="dialog" label="Review dialog" isOpen={overlayOpen} onClose={closeOverlay} className="rounded-lg border border-hairline-strong bg-canvas p-4">
                        ...
                        <UiModalOverlay key="modal-overlay" label="Modal overlay" isOpen={false} className="rounded-md border border-hairline-strong bg-canvas-soft p-3">
                            <UiText key="overlay-copy" label="Modal overlay surface" />
                        </UiModalOverlay>
                        <UiModal key="modal" label="Modal" isOpen={false} onClose={closeOverlay} className="rounded-lg border border-hairline-strong bg-canvas p-3">
                            <UiCard key="modal-card" className="p-4">
                                <UiText key="modal-copy" label="Modal content" />
                            </UiCard>
                        </UiModal>
                    </UiGroup>
                    <UiGroup key="disclosure-card" label="Disclosure and popover primitives" className="gap-3 rounded-lg border border-hairline-strong bg-canvas p-4">
                        ...
                        <UiPopover key="popover" isOpen={false} className="p-4">
                ...
                <UiToolbar key="feedback-files-grid" orientation="horizontal" className="grid w-full grid-cols-2 gap-4 rounded-none border-none bg-transparent p-0">
                    <UiGroup key="feedback-card" label="Feedback" className="gap-4 rounded-lg border border-hairline-strong bg-canvas p-4">
                        ...
                        <UiVirtualizer key="virtualizer" label="Virtual list" layout="list" orientation="vertical" itemCount={120} estimatedItemSize={40} visibleStart={0} visibleEnd={4} overscan={2} gap={4} padding={8} className="h-40 w-full rounded-md border border-hairline-strong bg-canvas-soft p-3">
                    ...
                    <UiGroup key="files-card" label="Files and drag/drop" className="gap-4 rounded-lg border border-hairline-strong bg-canvas p-4">
                        ...
                        <UiDraggable key="draggable" onDragStart={record} onDragMove={record} onDragEnd={record} dragType="text/plain" dragValue="component-card" isDragging={true} className="h-10 w-fit rounded-md border border-hairline-strong bg-canvas-soft px-3 py-2">
                            Draggable component card
                        </UiDraggable>
                        <UiDroppable key="droppable" label="Drop target" onDrop={setValue} onDropEnter={record} onDropExit={record} onDropMove={record} acceptedDragTypes="text/plain" dropOperation="move" isDropTarget={true} className="h-24 w-full rounded-md border border-dashed border-hairline-strong bg-canvas-soft p-4">
                            Drop target
